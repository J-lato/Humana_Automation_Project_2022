...
public class T3_YahooScenario_ReusableAnnotations extends ReusableAnnotationsTestNG {
        ...
        public void tc001_verifySignedInOptionIsChecked() throws InterruptedException {
            ...
            ReusableActionLogger.clickAction(driver,"//*[@class = '_yb_1933e']",logger,"Sign In");
        ...
        public void tc002_verifySignedInOptionIsUnChecked() {
            ...
            ReusableActionLogger.clickAction(driver,"//*[@class= 'stay-signed-in checkbox-container']",logger,"Check Box Unchecked");
            //we need to verify that signed in option is checked
            boolean isSignInChecked = driver.findElement(By.xpath("//*[@id= 'persistent']")).isSelected();
            System.out.println("The checkbox check condition is: " + isSignInChecked);
            logger.log(LogStatus.INFO,"The checkbox check condition is: " + isSignInChecked);
